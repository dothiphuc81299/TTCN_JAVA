    ...
    <div id="page-inner">
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div> <p> Để  vào hệ thống, bạn cần đăng nhập username : <b>admin</b>, password :<b>1234</b> </p>   
                            </div>
                     <div> <p>Sau khi đăng nhập bạn có thể thực hiện các chức năng khác như</p>
                     <p>CRUD các danh mục </p>
                     <p>CRUD các loại nhạc</p>
                     <p>CRUD các user</p>
